...
const Menu =() => {
    return (
        <section className="menu section" id="menu">
            <h2 className='section__title' data-title='Our Products'>
                ...
                {menu.map(({img, title, description, price}, index)=> {
                    return (
                        <div className="menu__item grid" key={index}>
                            <div className="menu__img-wrapper"><img src={img} alt="" className="menu__img"/> 
                            </div> 
                        ...
                        <span className="menu__price">RM{price}</span>
                      </div>
                    </div>
                    );
                })}
